...
export namespace ansiTest {
	...
	export function wrapStringTest() {
	...
	export function formatTreeTest() {
		assert.strictEqual(ansi.formatTree([
			{ indent: 0, content: "1" },
			{ indent: 1, content: "1-1" },
			{ indent: 1, content: "1-2" },
			{ indent: 1, content: "1-3" },
			{ indent: 0, content: "2" }
		], 12), [
			"1",
			"├─ 1-1",
		...
		assert.strictEqual(ansi.formatTree([
			...
			{ indent: 1, content: "1-2" },
			{ indent: 1, content: "1-3" },
			{ indent: 2, content: "1-3-1" },
			{ indent: 2, content: "1-3-2" },
			{ indent: 0, content: "2" }
		], 12), [
			"1",
			"├─ 1-1",
		...
		assert.strictEqual(ansi.formatTree([
			...
			{ indent: 1, content: "1-1" },
			{ indent: 1, content: "1-2" },
			{ indent: 2, content: "1-2-1" },
			{ indent: 2, content: "1-2-2" },
			{ indent: 1, content: "1-3" },
			{ indent: 2, content: "1-3-1" },
			{ indent: 2, content: "1-3-2" },
			{ indent: 0, content: "2" }
		...
		assert.strictEqual(ansi.formatTree([
			{ icon: "+ ", indent: 1, content: "1-1" },
			{ icon: "+ ", indent: 1, content: "1-2" },
			{ icon: "+ ", indent: 2, content: "1-2-1" },
			{ icon: "+ ", indent: 2, content: "1-2-2" },
			{ icon: "+ ", indent: 1, content: "1-3" },
			{ icon: "+ ", indent: 2, content: "1-3-1" },
			{ icon: "+ ", indent: 2, content: "1-3-2" }
		], Infinity), [
			"+ ├─ 1-1",
			"+ ├─ 1-2",
			"+ │  ├─ 1-2-1",
		...
		assert.strictEqual(ansi.formatTree([
			{ indent: 1, content: "1-1" },
			{ indent: 1, content: "1-2" },
			{ indent: 2, content: "1-2\n-1" },
			{ indent: 2, content: "1-2-2" },
			{ indent: 3, content: "1-2-2\n-1" },
			{ indent: 1, content: "1-3" },
			{ indent: 2, content: "1-3-1" },
			{ indent: 2, content: "1-3-2" }
		], Infinity), [
