...
import { CommandLineOption, formatCommandLineOptions, parseCommandLineArguments } from "../../utils/commandLine"
...
server.start().then(() => {
	console.log(color(`Server Running At ${server.url}`, ANSIColor.green))
