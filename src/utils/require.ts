...
export function registerESMLoader(extension = ".js") {
	...
	require.extensions[extension] = (module: any, filename) => module._compile(transformESModuleToCommonJS(stripBOM(readFileSync(filename, "utf8"))), filename)
 ...
 * 取消注册 ES6 模块加载器
 * @param extension 支持的模块扩展名
 * @param originalLoader 原始模块加载器
 */
export function unregisterESMLoader(extension = ".js", originalLoader = (module: any, filename: string) => module._compile(stripBOM(readFileSync(filename, "utf8")), filename)) {
