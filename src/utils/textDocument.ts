...
export class TextDocument {
	 ...
	 */
	constructor(content: string, path?: string, sourceMap?: SourceMapData) {
	 ...
	 */
	write(writer: TextWriter, ...args: readonly any[]) {
 ...
 * @returns 返回替换后的数据
 */
export function splice(data: { content: string, path?: string, sourceMap?: SourceMapData }, index: number, deleteCount: number, insert: any) {
 ...
 * @returns 返回替换后的数据
 */
export function replace(data: { content: string, path?: string, sourceMap?: SourceMapData }, search: string | RegExp, replacement: any | ((source: string, ...args: any[]) => string)) {
